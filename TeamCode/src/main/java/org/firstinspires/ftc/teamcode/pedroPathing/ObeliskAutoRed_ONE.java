...
@Autonomous(name="ObeliskAutoRed_ONE", group="Linear OpMode")
public class ObeliskAutoRed_ONE extends OpMode {
    ...
    private final Pose OpenGatePose = new Pose(135, 62, Math.toRadians(270));
    private final Pose NotPushBall = new Pose(120, 60, Math.toRadians(270));
    private final Pose startPose = new Pose(120, 128, Math.toRadians(270));// Start Pose of our robot.
    private final Pose ReadMotifPose = new Pose(94, 84, Math.toRadians(270));
    private final Pose scorePose = new Pose(96, 88, Math.toRadians(227)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
